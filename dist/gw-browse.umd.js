...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"14a0250a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/browse.vue?vue&type=template&id=0796a8b6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"browse-list"},[_c('modal',{attrs:{"draggable":true,"adaptive":true,"scrollable":true,"height":"auto","name":"custom-filters-form"}},[_c('custom-filters-form',{attrs:{"fields":_vm.customFilterFields,"resource-name":_vm.resource.slug,"mode":"form"},on:{"saved":function($event){return _vm.closeAddCustomFilter()}}})],1),(_vm.showTitle)?_c('h4',{staticClass:"section-title"},[_vm._v(" "+_vm._s(_vm.resource.name)+" ")]):_vm._e(),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.loading),expression:"!loading"}]},[_c('div',{staticClass:"table-container m-b-0"},[_vm._t("resource-actions",[(_vm.showResourceActions)?_c('resource-actions',{attrs:{"bulk-actions":_vm.bulkActionsList,"create-resource-url":_vm.createResourceUrl,"current-resource":_vm.resource,"custom-filter-fields":_vm.customFilterFields,"filterable-fields":_vm.filterableFields,"search-options":_vm.searchOptions,"search-placeholder":_vm.searchPlaceholder,"show-bulk-actions":_vm.showBulkActions,"show-create-resource":_vm.showCreateResource,"show-search-filters":_vm.showSearchFilters,"quick-filters":_vm.quickFilters},on:{"getData":_vm.getData,"run-action":_vm.runAction,"show-custom-filters-form":function($event){return _vm.$modal.show('custom-filters-form')},"add":function (event) { return _vm.$emit('add', event); }},scopedSlots:_vm._u([{key:"before-search-bar",fn:function(){return [_vm._t("before-search-bar")]},proxy:true},{key:"after-search-bar",fn:function(){return [_vm._t("after-search-bar")]},proxy:true},{key:"after-create-resource",fn:function(){return [_vm._t("after-create-resource")]},proxy:true}],null,true)}):_vm._e()],{"data":{ searchOptions: _vm.searchOptions }},{ searchOptions: _vm.searchOptions, getData: _vm.getData, filterableFields: _vm.filterableFields }),(_vm.showPagination && _vm.showPaginationTop)?_c('div',{staticClass:"pagination-controls pc-top row"},[_vm._t("before-pagination")],2):_vm._e(),_c('div',{staticClass:"table-responsive"},[_c('vuetable',{ref:"Vuetable",staticClass:"table table-condensed",attrs:{"api-url":_vm.resourceURL,"append-params":_vm.vuetableQueryParams,"css":_vm.vuetableStyles,"data-path":_vm.dataPath,"fields":_vm.tableFields,"http-fetch":_vm.httpFetch,"http-options":_vm.httpOptions,"pagination-path":_vm.paginationPath,"per-page":_vm.perPage,"query-params":_vm.queryParams,"row-class":_vm.rowClass,"show-sort-icons":true,"sort-order":_vm.sortOrder,"track-by":"id"},on:{"vuetable:load-error":function (response) { return _vm.$emit('load-error', response); },"vuetable:loaded":function($event){_vm.loading = false},"vuetable:loading":function($event){_vm.loading = true},"vuetable:pagination-data":_vm.onPaginationData,"vuetable:row-clicked":_vm.open},scopedSlots:_vm._u([{key:"actions",fn:function(props){return _vm._t("actions",[_c('div',{staticClass:"d-flex align-items-center justify-content-end"},[_vm._t("actions-before",null,null,Object.assign({}, props)),_vm._t("actions-edit",[(_vm.showActionsEdit)?_c('button',{staticClass:"btn btn-primary btn-sm",attrs:{"type":"button"},on:{"click":function($event){return _vm.editResource(props.rowData.id)}}},[_c('i',{staticClass:"fa fa-edit"})]):_vm._e()],null,Object.assign({}, props)),_vm._t("actions-delete",[(_vm.showActionsDelete)?_c('button',{staticClass:"btn btn-danger btn-sm",attrs:{"type":"button"},on:{"click":function($event){return _vm.confirmDelete(props)}}},[_c('i',{staticClass:"fa fa-trash-alt"})]):_vm._e()],null,Object.assign({}, props)),_vm._t("actions-after",null,null,Object.assign({}, props))],2)],null,Object.assign({}, props))}}],null,true)})],1),(_vm.showPagination && _vm.showPaginationBottom)?_c('div',{staticClass:"pagination-controls pc-bottom row"},[(_vm.showResultsPerPage)?[_c('div',{staticStyle:{"display":"flex","flex-direction":"row","justify-content":"center","align-content":"flex-start"}},[_vm._m(0),_c('div',[_c('multiselect',{attrs:{"allow-empty":false,"show-labels":false,"options":_vm.resultsPerPageOptions,"searchable":false,"placeholder":""},on:{"input":_vm.changePerPage},model:{value:(_vm.selectedPerPage),callback:function ($$v) {_vm.selectedPerPage=$$v},expression:"selectedPerPage"}})],1)])]:_vm._e(),_c('vuetable-pagination',{ref:"paginationBottom",staticClass:"col-auto",attrs:{"css":_vm.pagination},on:{"vuetable-pagination:change-page":_vm.onChangePage}})],2):_vm._e()],2)]),_vm._t("loading",[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.loading),expression:"loading"}],staticClass:"loading"},[_c('img',{attrs:{"src":"https://mc-canvas.s3.amazonaws.com/progress-circle.svg","width":"48","height":"48"}})])])],2)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"mx-3"},[_c('label',{staticClass:"mt-1"},[_vm._v("Results per page:")])])}]


// CONCATENATED MODULE: ./src/browse.vue?vue&type=template&id=0796a8b6&
...
function getQuickFiltersParams(quickFilters) {
  return quickFilters.reduce((acc, item) => {
    if (item.appendParam) {
      acc[item.appendParam] = item.getValue ? item.getValue(item.active) : Boolean(item.active);
    }
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"14a0250a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/resource-actions.vue?vue&type=template&id=370c4450&
var resource_actionsvue_type_template_id_370c4450_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"browse-actions row"},[_vm._t("before-search-bar"),_c('div',{staticClass:"input-group search-bar col-12 col-md-7 col-lg-7"},[_c('div',{staticClass:"form-control",staticStyle:{"display":"flex"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.search.text),expression:"search.text"}],staticStyle:{"all":"unset","width":"100%"},attrs:{"placeholder":_vm.searchPlaceholder,"type":"text"},domProps:{"value":(_vm.search.text)},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.getData()},"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.search, "text", $event.target.value)}}}),_c('div',{staticClass:"input-group-append"},[_c('button',{staticStyle:{"background-color":"transparent","border":"none","color":"#4B4B4B"},on:{"click":function($event){return _vm.getData()}}},[_c('i',{staticClass:"fa fa-search"})])])]),(_vm.showSearchFilters)?_c('div',{staticClass:"browse-list-filters d-flex align-items-center"},[_c('multiselect',{attrs:{"limit":1,"multiple":true,"options":_vm.filterableFields,"show-labels":false,"label":"title","placeholder":"All fields","track-by":"name"},on:{"input":function($event){return _vm.getData()}},model:{value:(_vm.searchFilters),callback:function ($$v) {_vm.searchFilters=$$v},expression:"searchFilters"}},[(_vm.customFilterFields.length)?_c('template',{slot:"afterList"},[_c('div',{staticClass:"custom-filters-form-btn option__desc"},[_c('a',{staticClass:"option__title",on:{"click":function($event){return _vm.$emit('show-custom-filters-form')}}},[_c('i',{staticClass:"fa fa-plus"}),_vm._v(" Add custom Filter ")])])]):_vm._e()],2)],1):_vm._e(),(_vm.showClearSearch)?_c('div',{staticClass:"input-group-append"},[_c('button',{staticClass:"btn btn-danger btn-sm",on:{"click":function($event){return _vm.clearSearch()}}},[_c('i',{staticClass:"fa fa-times"})])]):_vm._e()]),_vm._t("after-search-bar"),(_vm.searchQuickFilters.length)?_c('div',{staticClass:"col-auto browse-actions__quick-filters"},[_c('div',{staticClass:"btn-group",attrs:{"role":"group","aria-label":"quick filters"}},_vm._l((_vm.searchQuickFilters),function(filter){return _c('button',{key:("quick-filter-" + (filter.name)),staticClass:"btn btn-secondary",class:{
                    'btn-secondary': filter.active,
                    'btn-outline-secondary': !filter.active
                },attrs:{"type":"button"},on:{"click":function($event){return _vm.toogleQuickFilter(filter)}}},[_vm._v(" "+_vm._s(filter.title)+" ")])}),0)]):_vm._e(),(_vm.showBulkActions)?_c('dropdown',{staticClass:"bulk-actions col-auto ml-auto",attrs:{"is-icon":false}},[_c('button',{staticClass:"btn btn-info dropdown-toggle",attrs:{"slot":"btn","id":"bulk-actions","type":"button"},slot:"btn"},[_vm._v(" Bulk actions ")]),_c('div',{attrs:{"slot":"body"},slot:"body"},_vm._l((_vm.bulkActions),function(action){return _c('a',{key:action.name,staticClass:"dropdown-item",attrs:{"href":"#"},on:{"click":function($event){$event.preventDefault();return _vm.$emit('run-action', action.action)}}},[_vm._v(" "+_vm._s(action.name)+" ")])}),0)]):_vm._e(),(_vm.showCreateResource)?_c('div',{staticClass:"col-auto"},[_c('button',{staticClass:"add-record-btn btn btn-primary p-2",on:{"click":function($event){return _vm.$emit('add', _vm.currentResource.title)}}},[_c('i',{staticClass:"d-none d-sm-inline fa fa-plus-circle"}),_vm._v(" Add "+_vm._s(_vm.singularize(_vm.currentResource.title))+" ")])]):_vm._e(),_vm._t("after-create-resource")],2)}
var resource_actionsvue_type_template_id_370c4450_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/resource-actions.vue?vue&type=template&id=370c4450&
...
/* harmony default export */ var resource_actionsvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      searchQuickFilters: clone_default()(this.quickFilters)
    };
  },
  ...
  watch: {
    ...
    quickFilters(value) {
      this.searchQuickFilters = clone_default()(value);
    }
...
var resource_actions_component = normalizeComponent(
  ...
  resource_actionsvue_type_template_id_370c4450_render,
  resource_actionsvue_type_template_id_370c4450_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var browsevue_type_script_lang_js_ = ({
  ...
  methods: {
    open(event) {
      ...
      const isAction = target.classList.contains("fa-solid") || target.classList.contains("fa-ellipsis-vertical") || target.classList.contains("table-actions") || target.classList.contains("justify-content-end");
